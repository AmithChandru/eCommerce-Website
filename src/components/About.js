...
const About = () => {
  return (
    <div className="AboutContainer">
      <span style={{fontSize: '30px', fontWeight: 'bold'}}>About</span>
      <div>
        <img className='ImageAbout' src='https://prasadyash2411.github.io/ecom-website/img/Album%201.png' alt='Band' />
        <p className='text'>
